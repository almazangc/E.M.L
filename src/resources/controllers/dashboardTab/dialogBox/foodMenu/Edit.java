...
import resources.controllers.dashboardTab.FoodMenuList;
...
public class Edit  implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        TitleBar.setOnMouseDragged(event -> {
            FoodMenuList.newStage.setX(event.getScreenX() - xOffset);
            FoodMenuList.newStage.setY(event.getScreenY() - yOffset);
        });
    }
